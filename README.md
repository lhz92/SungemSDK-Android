...
| 返回值    | 函数名  | 描述 |
| :----- | :------ | :----------: |
| int | [allocateGraph(String filename)](#allocategraph) | 分配卷积神经网络模型到角蜂鸟，传入文件路径|
...
1. **<h1 id="allocategraph">allocateGraph(String filename)</h1>**：此函数是分配一个神经网络模型给角蜂鸟，通过加载该模型来实现某个功能
